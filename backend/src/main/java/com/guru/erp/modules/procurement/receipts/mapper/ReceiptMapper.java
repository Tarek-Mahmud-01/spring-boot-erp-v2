package com.guru.erp.modules.procurement.receipts.mapper;
...
import com.guru.erp.modules.procurement.receipts.dto.ReceiptDtos.GrnLineResponse;
...
public interface ReceiptMapper {
    ...
    default Long amount(com.guru.erp.platform.money.Money m) {
        return m == null ? null : m.amountMinor();
    }

    /** Null-safe currency accessor for an optional embedded Money. */
    default String currency(com.guru.erp.platform.money.Money m) {
