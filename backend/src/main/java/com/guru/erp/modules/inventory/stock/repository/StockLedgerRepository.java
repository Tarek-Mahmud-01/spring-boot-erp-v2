...
public interface StockLedgerRepository extends JpaRepository<StockLedger, Long> {
    ...
    List<StockLedger> listEntries(
        ...
        @Param("movementType") com.guru.erp.modules.inventory.stock.domain.MovementType movementType,
    ...
    List<StockAvailabilityRow> aggregateAvailability(
        ...
        @Param("status") com.guru.erp.modules.inventory.stock.domain.StockStatus status);
}
