...
public interface GlPeriodQueryRepository extends JpaRepository<JournalEntry, Long> {
    ...
    @Query("""
        ...
        where e.companyId = :companyId
          and e.status = com.guru.erp.modules.finance.gl.domain.JournalEntryStatus.DRAFT
    ...
    @Query("""
        ...
        where e.companyId = :companyId
          and e.status = com.guru.erp.modules.finance.gl.domain.JournalEntryStatus.POSTED
