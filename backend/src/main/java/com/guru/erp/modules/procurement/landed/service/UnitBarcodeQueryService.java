...
import com.guru.erp.modules.procurement.landed.domain.UnitBarcodeStatus;
...
import com.guru.erp.modules.procurement.landed.repository.LabelSizeRepository;
import com.guru.erp.modules.procurement.landed.repository.UnitBarcodeRepository;
...
public class UnitBarcodeQueryService {
    ...
    public UnitBarcodeResponse getBundle(String publicId) {
        var ub = repository.findByPublicId(publicId)
            .filter(com.guru.erp.modules.procurement.landed.domain.UnitBarcode::isBundle)
