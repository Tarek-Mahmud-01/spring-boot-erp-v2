...
import com.springboot.erp.modules.procurement.bills.domain.QSupplierBill;
import com.springboot.erp.modules.procurement.orders.domain.PoStatus;
import com.springboot.erp.modules.procurement.orders.domain.QPurchaseOrder;
import com.springboot.erp.modules.procurement.receipts.domain.GrnStatus;
import com.springboot.erp.modules.procurement.receipts.domain.QGoodsReceipt;
import com.springboot.erp.modules.reporting.invproc.dto.InvProcReportDtos.PoAgingRow;
import com.springboot.erp.modules.reporting.invproc.dto.InvProcReportDtos.PoAgingSummary;
...
/**
 * PO / GRN / Bill Aging (RPT-E004-PO-AGING) — one row per {@link com.springboot.erp.modules.procurement.orders.domain.PurchaseOrder}
 * with its latest linked {@link com.springboot.erp.modules.procurement.receipts.domain.GoodsReceipt} and
 * {@link com.springboot.erp.modules.procurement.bills.domain.SupplierBill}, and an aging bucket computed
