 ...
 * event to the platform {@link com.springboot.erp.platform.outbox.OutboxPublisher} instead of calling the
...
public class LandedCostPostingService {
    ...
    private final com.springboot.erp.platform.outbox.OutboxPublisher outbox;

    public LandedCostPostingService(com.springboot.erp.platform.outbox.OutboxPublisher outbox) {
        this.outbox = outbox;
    }
