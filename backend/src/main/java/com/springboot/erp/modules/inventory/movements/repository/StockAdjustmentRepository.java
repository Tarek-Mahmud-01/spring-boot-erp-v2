package com.springboot.erp.modules.inventory.movements.repository;
...
public interface StockAdjustmentRepository extends JpaRepository<StockAdjustment, Long> {
    ...
    @Query("""
        ...
        where (:locationId is null or a.locationId = :locationId)
          ...
          and (:search is null
               or lower(a.number) like lower(concat('%', cast(:search as string), '%'))
               or lower(a.reason) like lower(concat('%', cast(:search as string), '%')))
