...
import com.springboot.erp.modules.reporting.finance.dto.FinanceReportDtos.IncomeStatementLine;
...
public class IncomeStatementReportService {
    ...
    public IncomeStatementResponse run(String companyId, LocalDate fromDate, LocalDate toDate, String locationId) {
        if (toDate.isBefore(fromDate)) {
            throw new com.springboot.erp.platform.error.DomainException(
                com.springboot.erp.platform.error.ErrorCode.VALIDATION_FAILED, "toDate must be on or after fromDate");
        }
