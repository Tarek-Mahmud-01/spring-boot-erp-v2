...
import com.springboot.erp.modules.inventory.movements.domain.QStockTransfer;
import com.springboot.erp.modules.inventory.movements.domain.QStockTransferLine;
...
import com.springboot.erp.modules.reporting.invproc.dto.InvProcReportDtos.TransferLineRow;
import com.springboot.erp.modules.reporting.invproc.dto.InvProcReportDtos.TransferSummary;
 ...
 * {@code transfer_register_report}). {@link com.springboot.erp.modules.inventory.movements.domain.StockTransferLine}
 * has no {@code variant_id} column, so the variant is resolved via a correlated scalar subquery on
 * {@link com.springboot.erp.modules.inventory.stock.domain.StockLedger}: the destination
