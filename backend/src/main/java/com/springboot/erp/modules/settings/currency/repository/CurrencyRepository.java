package com.springboot.erp.modules.settings.currency.repository;
...
public interface CurrencyRepository extends JpaRepository<Currency, Long> {
    ...
    @Query("""
        ...
        where (:q is null
               ...
               or lower(c.shortName) like lower(concat('%', cast(:q as string), '%'))
               or lower(c.country) like lower(concat('%', cast(:q as string), '%')))
